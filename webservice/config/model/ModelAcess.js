const fs = require('fs');
const HandleDBMSMySQL = require('../config/database/HandleDBMySQL');
...
class ModelAcess {
    ...
    destroy(param=null) {
        ...
        new Error('Parâmetros incorretos para a classe: \`%s\`, parâmetro \`%s\`', this.cosntructor.name, varToString({param}));
    }
